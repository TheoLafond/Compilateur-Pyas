...
print("Namesdefinedinglobalnamespaceare")
print(dir())
print("Namesdefinedinsidetheemptylistobjectare")
print(dir([]))  # names inside list object
print("Namesdefinedinsidethedirfunctionare")
print(dir(dir))
...
print("Namesdefinedintheglobalnamespaceare")
print(dir.__call__())
